<!-- 5. Write a program to create file named “employee.txt” to store empno, name, gender  -->
<!-- and mobileno. Open the same file again to display the content of the file. (A) -->
